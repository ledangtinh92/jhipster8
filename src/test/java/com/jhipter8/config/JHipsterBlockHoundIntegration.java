...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jhipter8.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jhipter8.security.DomainUserDetailsService", "createSpringSecurityUser");
